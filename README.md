...
- Dois streams por episódio quando disponíveis: **Principal — FullHD / HLS** e **Alternativo — Player 2**.
- O player é aberto pelo `externalUrl` do iframe original, preservando cookies, scripts e eventuais verificações do site.
