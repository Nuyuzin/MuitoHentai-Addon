...
app.get('/stream/:type/:id.json', async (req, res) => {
  ...
  try {
    ...
    const streams = [];
    if (frames[0]) streams.push({ name: 'Principal', title: 'Principal • FullHD / HLS', externalUrl: frames[0] });
    if (frames[1]) streams.push({ name: 'Alternativo', title: 'Alternativo • Player 2', externalUrl: frames[1] });
